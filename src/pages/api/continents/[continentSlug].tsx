...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const europe = [
    ...
    { city: 'Stockholm', citySlug: 'stockholm', code: 'se', country: 'Sweden', entries: '2.60', continentName: 'Europa'},
    ...
    { city: 'St Petersburg', citySlug: 'st_petersburg', code: 'ru', country: 'Russia', entries: '4.00', continentName: 'Europa'},
  ...
  const asia = [
    { city: 'Ho Chi Minh', citySlug: 'ho_chi_minh', code: 'vn', country: 'Vietnam', entries: '7.20', continentName: 'Ásia'},
    ...
    { city: 'Taipei', citySlug: 'taipei', code: 'tw', country: 'Taiwan', entries: '9.60', continentName: 'Ásia'},
    ...
    { city: 'Johor Bahru', citySlug: 'johor_bahru', code: 'my', country: 'Malaysia', entries: '6.40', continentName: 'Ásia'},
    ...
    { city: 'Shenzhen', citySlug: 'shenzhen', code: 'cn', country: 'China', entries: '12.20', continentName: 'Ásia'},
    ...
    { city: 'Guangzhou', citySlug: 'guangzhou', code: 'cn', country: 'China', entries: '9.00', continentName: 'Ásia'}
  ]

  const oceania = [
    { city: 'Auckland', citySlug: 'auckland', code: 'nz', country: 'New Zealand', entries: '2.80', continentName: 'Oceania'},
  ...
  const north_america = [
    ...
    { city: 'New York City', citySlug: 'new_york_city', code: 'us', country: 'United States', entries: '13.60', continentName: 'America do Norte'},
    { city: 'Miami', citySlug: 'miami', code: 'us', country: 'United States', entries: '8.12', continentName: 'America do Norte'},
    { city: 'Los Angeles', citySlug: 'los_angeles', code: 'us', country: 'United States', entries: '7.50', continentName: 'America do Norte'},
