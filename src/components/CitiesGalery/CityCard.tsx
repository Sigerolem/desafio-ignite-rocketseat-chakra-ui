...
export function CityCard({cityName, citySlug, cityContinentSlug, cityEntries, cityCountryName, cityCountryCode}:CityCardProps) {
  return (
    <Tooltip label={`${cityEntries} milhões de turistas por ano`} >
      <Box 
        h={['280px']} 
        w={['260px']}
        mx="auto"
